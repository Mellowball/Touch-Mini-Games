# PyInstaller 실행 명령어
# python -m PyInstaller --add-data "assets/background.jpg;assets" --add-data "assets/select2.png;assets" --add-data "assets/Quit Rect.png;assets" --add-data "assets/peace_pic.jpg;assets" --add-data "assets/space.png;assets" --add-data "assets/ship.png;assets" --add-data "assets/bang.png;assets" --add-data "assets/Quit_Button.png;assets" --add-data "score_record.db;." --add-data "sounds/game_ready.mp3;sounds" --add-data "sounds/game_start.mp3;sounds" --add-data "sounds/main_touch.mp3;sounds" --add-data "sounds/game_touch.mp3;sounds" --add-data "sounds/react_end.mp3;sounds" --add-data "sounds/remem_correct.mp3;sounds" --add-data "sounds/remem_incorrect.mp3;sounds" --add-data "sounds/remem_end.mp3;sounds" --add-data "sounds/space_bang.mp3;sounds" --add-data "sounds/space_start.mp3;sounds" --add-data "sounds/space_end.mp3;sounds" --add-data "sounds/space_bg.mp3;sounds" --onefile main_game_pyinstall_ver.py
...
# PyInstaller가 생성한 임시 폴더에 접근
db_path = os.path.join(sys._MEIPASS, 'score_record.db')
assets_background = os.path.join(sys._MEIPASS, 'assets/background.jpg')
assets_select2 = os.path.join(sys._MEIPASS, 'assets/select2.png')
assets_quit_rect = os.path.join(sys._MEIPASS, 'assets/Quit Rect.png')
assets_peace_pic = os.path.join(sys._MEIPASS, 'assets/peace_pic.jpg')
assets_space = os.path.join(sys._MEIPASS, 'assets/space.png')
assets_ship = os.path.join(sys._MEIPASS, 'assets/ship.png')
assets_bang = os.path.join(sys._MEIPASS, 'assets/bang.png')
assets_quit_button = os.path.join(sys._MEIPASS, 'assets/Quit_Button.png')
# 사운드 파일
sound_game_ready = pygame.mixer.Sound(os.path.join(sys._MEIPASS, 'sounds/game_ready.mp3'))
sound_game_start = pygame.mixer.Sound(os.path.join(sys._MEIPASS, 'sounds/game_start.mp3'))
sound_main_touch = pygame.mixer.Sound(os.path.join(sys._MEIPASS, 'sounds/main_touch.mp3'))
sound_game_touch = pygame.mixer.Sound(os.path.join(sys._MEIPASS, 'sounds/game_touch.mp3'))
sound_react_end = pygame.mixer.Sound(os.path.join(sys._MEIPASS, 'sounds/react_end.mp3'))
sound_remem_correct = pygame.mixer.Sound(os.path.join(sys._MEIPASS, 'sounds/remem_correct.mp3'))
sound_remem_incorrect = pygame.mixer.Sound(os.path.join(sys._MEIPASS, 'sounds/remem_incorrect.mp3'))
sound_remem_end = pygame.mixer.Sound(os.path.join(sys._MEIPASS, 'sounds/remem_end.mp3'))
sound_space_bang = pygame.mixer.Sound(os.path.join(sys._MEIPASS, 'sounds/space_bang.mp3'))
sound_space_start = pygame.mixer.Sound(os.path.join(sys._MEIPASS, 'sounds/space_start.mp3'))
sound_space_end = pygame.mixer.Sound(os.path.join(sys._MEIPASS, 'sounds/space_end.mp3'))
sound_space_bg = pygame.mixer.Sound(os.path.join(sys._MEIPASS, 'sounds/space_bg.mp3'))
